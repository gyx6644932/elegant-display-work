...
'========================================================= 
' QQWry.DAT 利用程序
' 在ASP环境中使用纯真版QQWry.dat通过完美测试 
' 服务器环境不支持ADodb.Stream，将无法使用此程序 
' ======================================================== 
Function address0(sip) 
Dim Wry, IPType 
Set Wry = New TQQWry 
IPType = Wry.QQWry(sip) 
address0=""&Wry.Country & " " & Wry.LocalStr &"" 
End Function 

Function address1(sip) 
Dim Wry, IPType 
Set Wry = New TQQWry 
IPType = Wry.QQWry(sip) 
address1=Wry.Country
End Function 

Function address2(sip) 
Dim Wry, IPType 
Set Wry = New TQQWry 
IPType = Wry.QQWry(sip) 
address2=Wry.LocalStr
End Function 
...
LastStartIP = 0 
EndIPOff = 0
QQWryFile = "D:/database/QQWry.dat"
End Sub 
' ============================================ 
' IP地址转换成整数 
' ============================================ 
...
If InStr(Country, "CZ88.NET") Then Country = "中国" 
If InStr(LocalStr, "CZ88.NET") Then LocalStr = "中国" 
End Sub 
' ============================================ 
' 获取IP地址标识符 
' ============================================ 
