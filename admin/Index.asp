...
<title>网站后台管理中心--技术支持：蒂威科技   by:YYI</title>
</head>
<frameset rows="*" cols="178,*" framespacing="0" frameborder="1" border="false" id="frame" scrolling="yes">
  ...
  <frameset framespacing="0" border="false" rows="35,*" frameborder="0" scrolling="yes">
    ...
    <frame name="right" scrolling="yes" src="Main.asp">
  </frameset>
</frameset>
<noframes>
