...
if Request.QueryString("folder") <> "" and not isnull(Request.QueryString("folder")) then
	UploadDir="../Uploadfile/image/"&Request.QueryString("folder")&"/"
else
	UploadDir="../Uploadfile/image/"
end if
...
%>
  <tr class="tdbg" onMouseOver="this.className='tdbg3'" onMouseOut="this.className='tdbg'">
    ...
    <td class="t-center"><a href="<%=(UploadDir & theFile.Name)%>" title="<%=theFile.Name%>" rel="tpic" class="firstebox"><img src="<%=(UploadDir & theFile.Name)%>" width="80" border="0" /></a></td>
