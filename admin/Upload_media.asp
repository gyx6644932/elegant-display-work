...
if Request.QueryString("folder") <> "" and not isnull(Request.QueryString("folder")) then
	UploadDir="../Uploadfile/media/"&Request.QueryString("folder")&"/"
else
	UploadDir="../Uploadfile/media/"
end if
...
%>
  <tr class="tdbg" onMouseOver="this.className='tdbg3'" onMouseOut="this.className='tdbg'">
    ...
    <td class="t-center"><a href="<%=(UploadDir & theFile.Name)%>" title="<%=theFile.Name%>" target="_blank"><img src="../html/plugins/filemanager/images/folder-16.gif" border="0" /></a></td>
