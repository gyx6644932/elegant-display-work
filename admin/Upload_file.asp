...
if Request.QueryString("folder") <> "" and not isnull(Request.QueryString("folder")) then
	UploadDir="../Uploadfile/file/"&Request.QueryString("folder")&"/"
else
...
%>
  <tr class="tdbg" onMouseOver="this.className='tdbg3'" onMouseOut="this.className='tdbg'">
    ...
    <td class="t-center"><a href="<%=(UploadDir & theFile.Name)%>" title="<%=theFile.Name%>" target="_blank"><img src="../html/plugins/filemanager/images/file-16.gif" border="0" /></a></td>
