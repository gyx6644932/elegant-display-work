...
Const nSaturation = 225  '底色深度
Const nBlankNoisyDotOdds = 1.0 '空白处噪点率(底色)
Const nColorNoisyDotOdds = 1.0 '有色处噪点率(字符)
Const nNoisyLineCount = 0 '参杂线条数
Const nCharMin = 4 '产生的字符最小个数
Const nCharMax = 5 '产生的字符最大个数
Const nSpaceX = 2 '字符左右边距
Const nSpaceY = 2 '字符上下边距
Const nImgWidth = 60 '验证码总宽x
Const nImgHeight = 14 '验证码总高y
Const nCharWidthRandom = 16 '字符随机宽
Const nCharHeightRandom = 16 '字符随机高
Const nPositionXRandom = 10 '字符随机间距
Const nPositionYRandom = 10 '字符随机上下移
Const nAngleRandom = 0 '角度随机量
Const nLengthRandom = 0 '长度随机量(百分比)
Const nColorHue = -1 '色调(-2灰度，-1单色)
